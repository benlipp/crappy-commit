...
if [ $? -eq 1 ]; then
	...
	wget -O /usr/local/bin/crap https://raw.githubusercontent.com/obiwanakin/crappy-commit/master/hemorrhoid
    ...
    curl -o /usr/local/bin/crap https://raw.githubusercontent.com/obiwanakin/crappy-commit/master/hemorrhoid
